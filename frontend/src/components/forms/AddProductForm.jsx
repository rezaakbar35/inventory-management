        ...
        <div className="m-auto rounded-3xl w-1/3 h-[60%] bg-white p-5">
            ...
            <div className="text-3xl font-bold text-black mb-6">Add New Product</div>
              <div className="grid grid-cols-4">
                ...
                <input type="text" name="Product" id="Product" className="rounded-xl text-black p-2 m-1 col-span-3" /> 
                <input type="text" name="Product" id="Product" className="rounded-xl text-black p-2 m-1" />
              </div>
              <div className="grid grid-cols-4 mt-2">
                <div className="flex justify-start">
                <label htmlFor="Quantity" className="text-black italic font-light pl-2" >Quantity</label>
                </div>
                <div className="flex justify-start">
                <label htmlFor="Unit" className="text-black italic font-light pl-2">Unit</label>
                </div>
                <div className="flex justify-start col-span-2">
                <label htmlFor="Photo" className="text-black italic font-light pl-2">Product Photo</label>
                </div>
                <input type="number" name="Quantity" id="Quantity" className="rounded-xl text-black p-2 m-1" />
                <select name="Unit" id="Unit" className="rounded-xl border-none bg-gray-300 text-black p-2 m-1 placeholder:text-gray-400 placeholder:font-thin">
                  <option value="" disabled selected hidden className="text-gray-400">unit..</option>
                ...
                <div className="flex justify-start col-span-2">
                <label htmlFor="Category" className="text-black italic font-light pl-2">Category</label>
                </div>
                <input type="text" name="Category" id="Category" className="rounded-xl text-black p-2 m-1 col-span-2" />
                <div className="col-span-2"></div>
                <div className="flex justify-start col-span-2">
                <label htmlFor="Warehouse" className="text-black italic font-light pl-2">Warehouse</label>
                </div>
                <div className="col-span-2"></div>
                <input type="text" name="Warehouse" id="Warehouse" className="rounded-xl text-black p-2 m-1 col-span-2" />
            </div>
