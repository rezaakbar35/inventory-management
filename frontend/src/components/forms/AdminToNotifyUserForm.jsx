...
const AdminToNotifyUserForm = ({ visible, onClose }) => {
  ...
  return (
    <div id="container" onClick={handleOnClose} className="flex justify-center w-screen h-screen bg-black/30 absolute backdrop-blur">
        <div className="m-auto rounded-3xl w-1/3 h-3/4 bg-white p-5">
            ...
            <div className="text-3xl font-bold text-black mb-6">Notify User on Complaint Ticket</div>
              <div className="grid">
...
export default AdminToNotifyUserForm
